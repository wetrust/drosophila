<div class="container">
    ...
    <div class="row">
        <div class="col">
            ...
            <form action="<?php echo Config::get('URL'); ?>dashboard/process_action" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file" name="rar_file" required >
